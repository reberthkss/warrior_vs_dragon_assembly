...
.data
    ...
    msg_shield_skip: .asciiz "\n>>> [PLAYER] You hold your shield steady and brace for impact!\n"
    msg_choose_action_shielded: .asciiz "\n[PLAYER] Shield Active! (0)Skip (1)Cancel (6)Estus (7)Hold Shield - "
    msg_shield_error: .asciiz "\n[!] CANNOT ATTACK while shield is active! Use (1)Cancel (6)Estus (7)Hold\n"
